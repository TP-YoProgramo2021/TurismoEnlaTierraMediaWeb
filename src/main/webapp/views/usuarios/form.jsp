...
<br />
<label for="password" class="form-label" style="color: #f0eff4">Contraseña:
</label>
...
<br />
<label for="admin" class="form-label" style="color: #f0eff4">¿Es
	administrador?</label>
...
<br />
<label for="presupuesto" class="form-label" style="color: #f0eff4">Dinero:
</label>
...
<br />
<label for="tiempo" class="form-label" style="color: #f0eff4">Tiempo:
</label>
<input type="number" name="tiempo" step="0.1" class="form-control"
...
<br />
<label for="atr_preferida" class="form-label" style="color: #f0eff4">Tipo
	de atraccion preferida</label>
<select class="form-select" name="atr_preferida" required>
